...
public abstract class TypeComplex extends Type
{
	...
	if (!(obj instanceof TypeComplex)) { return false; }
	TypeComplex real_t = (TypeComplex) obj;
	if (this.componant.size() != real_t.componant.size()) { return false; }
	for (int i = 0; i < this.componant.size(); ++i)
	{
	    if (!this.componant.get(i).equals(real_t.componant.get(i))) { return false; }
	}
	return true;
    }
