...
public class TypeArrayRange extends TypeRange
{
	...
	{
	    if (!(getFirst() instanceof TypeInt)) { return false; }
	    if (((TypeInt) getFirst()).getConst_value() >= ((TypeInt) getLast()).getConst_value()) { return false; }
	}
	else if (getLast() instanceof TypeItemEnum)
	{
	    if (!(getFirst() instanceof TypeItemEnum)) { return false; }
	    if (!((TypeItemEnum) getFirst()).getRefEnumRange()
		    .equals(((TypeItemEnum) getLast()).getRefEnumRange())) { return false; }
    ...
    {
	return new TypeArrayRange((Type) this.first.clone(), (Type) this.last.clone());
    }
